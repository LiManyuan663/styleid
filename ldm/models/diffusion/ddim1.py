...
class DDIMSampler(object):
    ...
    #            **kwargs
    #            ):
    #     if conditioning is not None: # 代码中是None
    ...
    #         model_output = self.model.apply_model(x, t, c_in)
    #         # print(model_output)
    #     else:
    #         x_in = torch.cat([x] * 2)
    #         t_in = torch.cat([t] * 2)
    ...
    # 7.3 by manyuan
    @torch.no_grad()
    def encode_ddim(self, img, num_steps, conditioning=None, unconditional_conditioning=None ,unconditional_guidance_scale=1.0, \
